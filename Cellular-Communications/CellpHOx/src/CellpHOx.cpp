...
#line 1 "/Users/pjb/Dropbox/Results-in-Engineering/GitHub-Repo/Equipping-Smart-Coasts/Cellular-Communications/CellpHOx/src/CellpHOx.ino"
void setup();
void loop();
...
bool parseSeapHOx(char* new_var){
    ...
    Serial.printf("Error: improper or incomplete data received from SeapHOx");
    return false;
  }
}